...
import arcpy
arcpy.env.workspace=r"D:\Capstone\Group_2_Python.gdb"
arcpy.env.overwriteOutput = True

#data reprojection
coordinateSystem=arcpy.SpatialReference("NAD 1983 HARN StatePlane Arizona Central FIPS 0202 (Intl Feet)")
arcpy.Project_management(r"D:\Capstone\Group_2_Python.gdb\US_Tracts", "US_Tracts_Reprojected", coordinateSystem)
arcpy.Project_management(r"D:\Capstone\Group_2_Python.gdb\AZ_blck_grp_2017", "AZ_Block_Groups_Reprojected", coordinateSystem)
arcpy.Project_management(r"D:\Capstone\Group_2_Python.gdb\Mesa", "Mesa_Reprojected", coordinateSystem)
arcpy.Project_management(r"D:\Capstone\Group_2_Python.gdb\Scottsdale", "Scottsdale_Reprojected", coordinateSystem)
arcpy.Project_management(r"D:\Capstone\Group_2_Python.gdb\Employers2016", "Employers_Reprojected", coordinateSystem)
arcpy.Project_management(r"D:\Capstone\Group_2_Python.gdb\Valley_Metro_Bus_Stops", "Valley_Metro_Bus_Stops_Reprojected", coordinateSystem)
arcpy.Project_management(r"D:\Capstone\Group_2_Python.gdb\Valley_Metro_Light_Rail_Stations", "Valley_Metro_Light_Rail_Stations_Reprojected", coordinateSystem)
print("Reprojection complete")

#join census tract data to tract shapfile
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\US_Tracts_Reprojected", "US_Tracts_Layer")
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Mesa_Reprojected", "Mesa_Layer")
arcpy.AddJoin_management("US_Tracts_Layer", "GISJOIN", r"D:\Capstone\Group_2_Python.gdb\Census_Tract_Data", "GISJOIN")
...
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Scottsdale_Reprojected", "Scottsdale_Layer")
...
#find grocery stores
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Employers_Reprojected", "Employers_Layer")
...
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Grocery_Stores", "Grocery_Stores_Layer")
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Mesa_Tracts", "Mesa_Tracts_Layer")
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Scottsdale_Tracts", "Scottsdale_Tracts_Layer")
...
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Valley_Metro_Bus_Stops_Reprojected", "Valley_Metro_Bus_Stops_Layer")
arcpy.MakeFeatureLayer_management(r"D:\Capstone\Group_2_Python.gdb\Valley_Metro_Light_Rail_Stations_Reprojected", "Valley_Metro_Light_Rail_Stations_Layer")
...
arcpy.MakeFeatureLayer_management("Mesa_Tracts", "Mesa_Layer")
arcpy.AddJoin_management("AZ_Block_Groups_Layer", "GISJOIN", r"D:\Capstone\Group_2_Python.gdb\Block_Group_Data", "GISJOIN")
...
with arcpy.da.UpdateCursor("Mesa_Block_Group_Temp", ["Mesa_Block_Group_Bus_Stops_Buffer_Clip_POLY_AREA"]) as cursor:
    for row in cursor:
        if row[0] == None:
            row[0] = 0
        cursor.updateRow(row)
arcpy.CalculateField_management("Mesa_Block_Group_Temp", "Mesa_Focus_Block_Groups_Grocery_Coverage", "!Mesa_Block_Group_Bus_Stops_Buffer_Clip_POLY_AREA!/!Mesa_Focus_Block_Groups_POLY_AREA!")
